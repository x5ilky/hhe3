...
pub fn set_name(_env: Rc<RefCell<Env>>, args: Vec<Value>, outside: Rc<RefCell<EnvData>>) -> Result<Value, RuntimeError> {
...
pub fn show(_env: Rc<RefCell<Env>>, args: Vec<Value>, outside: Rc<RefCell<EnvData>>) -> Result<Value, RuntimeError> {
